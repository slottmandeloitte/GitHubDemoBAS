		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My App",
									"targetURL": "#comdeloitteflpuiflp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdeloitteflpuiflp-display": {
								"semanticObject": "comdeloitteflpuiflp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.deloitte.flp.uiflp",
									"url": sap.ui.require.toUrl("com/deloitte/flp/uiflp")
								}
							}
						}
					}
